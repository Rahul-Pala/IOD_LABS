...
function MoodChanger() {
  ...
  return (
    <div className="MoodChanger">
      Current Mood: {mood}
      {/* You can either use Arrow function or Custom event handler functions */}
      {/* Using arrow functions */}
      <button onClick={() => setMood("tired")}>Stay Up Late</button>
      <button onClick={() => setMood("Fit")}>Go to Gym</button>
      ...
      <button onClick={handleSoccer}>Score</button>
    </div>
  );
}
